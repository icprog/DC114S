...
#ifndef __MG_MQTT_CLIENT_H_
#define __MG_MQTT_CLIENT_H_

#include "MQTTPacket.h"
#include "mgMQTT.h" //Platform specific implementation header file(e.g: MICO platform)
...
#define DEFAULT_SENDBUF_SIZE  (1024)
